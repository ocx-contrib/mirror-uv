...
OCX mirror for [uv](https://github.com/astral-sh/uv). Publishes GitHub
releases to `ocx.sh/uv` with cascade tags after a smoke test per
`(version, platform)`.
...
Apache-2.0 — see [`LICENSE`](LICENSE). Upstream assets (uv logo, mirrored
